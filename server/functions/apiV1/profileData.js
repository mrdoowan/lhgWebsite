            ...
            if (profileObject && 'StatsLog' in profileObject) {
                ...
                cache.get(cacheKey, async (err, data) => {
                    ...
                    for (let i = 0; i < Object.keys(profileStatsJson['RoleStats']).length; ++i) {
                        ...
                        statsJson['AverageGoldDiffEarly'] = avgGoldDiffEarlyFloat.toFixed(1);
                        statsJson['AverageGoldDiffMid'] = avgGoldDiffMidFloat.toFixed(1);
                        statsJson['AverageGoldDiffEarlyToMid'] = (avgGoldDiffMidFloat - avgGoldDiffEarlyFloat).toFixed(1);
