        ...
        dynamoDbGetItem('Team', teamPId).then((teamObject) => {
            if (teamObject && 'StatsLog' in teamObject) {
                ...
                cache.get(cacheKey, async (err, data) => {
                    ...
                    tourneyStatsJson['AverageXpDiffEarly'] = (tourneyStatsJson['GamesPlayedOverEarly'] == 0) ? '' : (tourneyStatsJson['TotalXpDiffEarly'] / tourneyStatsJson['GamesPlayedOverEarly']).toFixed(1);
                    tourneyStatsJson['AverageXpDiffMid'] = (tourneyStatsJson['GamesPlayedOverMid'] == 0) ? '' : (tourneyStatsJson['TotalXpDiffMid'] / tourneyStatsJson['GamesPlayedOverMid']).toFixed(1);
                    ...
                    tourneyStatsJson['AverageGoldDiffEarly'] = (tourneyStatsJson['GamesPlayedOverEarly'] == 0) ? '' : avgGoldDiffEarlyFloat.toFixed(1);
                    tourneyStatsJson['AverageGoldDiffMid'] = (tourneyStatsJson['GamesPlayedOverMid'] == 0) ? '' : avgGoldDiffMidFloat.toFixed(1);
                    tourneyStatsJson['AverageTeamGoldDiffEarlyToMid'] = (tourneyStatsJson['GamesPlayedOverMid'] == 0) ? '' : (avgGoldDiffMidFloat - avgGoldDiffEarlyFloat).toFixed(1);
                    tourneyStatsJson['AverageCsDiffEarly'] = (tourneyStatsJson['GamesPlayedOverEarly'] == 0) ? '' : (tourneyStatsJson['TotalCsDiffEarly'] / tourneyStatsJson['GamesPlayedOverEarly']).toFixed(1);
                    tourneyStatsJson['AverageCsDiffMid'] = (tourneyStatsJson['GamesPlayedOverMid'] == 0) ? '' : (tourneyStatsJson['TotalCsDiffMid'] / tourneyStatsJson['GamesPlayedOverMid']).toFixed(1);
                    tourneyStatsJson['AverageTeamKillsEarly'] = (tourneyStatsJson['GamesPlayedOverEarly'] == 0) ? '' : (tourneyStatsJson['TotalTeamKillsAtEarly'] / tourneyStatsJson['GamesPlayedOverEarly']).toFixed(2);
                    tourneyStatsJson['AverageTeamKillsMid'] = (tourneyStatsJson['GamesPlayedOverMid'] == 0) ? '' : (tourneyStatsJson['TotalTeamKillsAtMid'] / tourneyStatsJson['GamesPlayedOverMid']).toFixed(2);
