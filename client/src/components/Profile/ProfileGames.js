        ...
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            ...
            <table>
              ...
              <tbody>
                {Object.keys(Matches).sort((a,b) => { return Matches[b].DatePlayed - Matches[a].DatePlayed; }).map((matchId) => {
                ...
                return (<tr key={matchId} className={(match.Invalid) ? classes.rowInvalid :
                  ...
                  classes.rowLose}>
                    <td className={classes.colDate}>
                      <Link to={`/match/${matchId}`} className={classes.link}>{getDateString(match.DatePlayed / 1000)}</Link>
                      <br />
